...
<div class="container">
    <div class="content">
        <div class="content py-3 py-lg-0 pl-3 pl-lg-5">
            ...
            @if($data->jenis == "Biologi")            
            <div class="col mb-4">
                <div class="card">
                <a href="{{ route('bio.show', $data->id) }}"><img src="{{ $data->image() }}" class="card-img-top img-thumbnail" alt="..."
                ...
                <div class="card-body">
                    ...
                    <a href="{{ route('bio.show', $data->id) }}" class="btn btn-primary">Lihat Materi</a>
                </div>
